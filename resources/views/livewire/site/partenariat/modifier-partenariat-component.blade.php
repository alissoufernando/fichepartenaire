            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <div class="card-body">
                                <form action="" wire:submit.prevent='updatePartner'>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 mt-3">
                                                <label class="form-label" for="name">9.4 Quels sont le nom et les
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 mt-3">
                                                <label class="form-label" for="name">9.5 Quel est le poste occupé
                                                    par le répondant au sein de
                                                    la structure ?</label>
                                                <input class="form-control" type="name" name="poste"
