    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
            @if ($type_id)
            <h5 class="modal-title text-center">Edit un type</h5>
            @else
            <h5 class="modal-title text-center">Ajouter un type</h5>
            @endif
          <button wire:click.prevent='resetInputFields' class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form class="form theme-form" wire:submit.prevent='saveType'>
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control form-control-lg" id="name" type="text" placeholder="nom du type" wire:model.lazy='name'>
                            </div>
                        </div>
                        </div>
                    </div>
