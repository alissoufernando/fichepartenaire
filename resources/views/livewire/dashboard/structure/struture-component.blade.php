                        ...
                        <div class="table-responsive table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" wire:click.prevent='getElementById({{ $structure->id }})'>  <i class="fa fa-edit m-5 text-warning"></i> </a>
                                    <a href="#" wire:click.prevent="deleteStructure({{$structure->id}})"> <i class="fa fa-trash-o fa-1x text-danger"></i> </a>
                                    </td>
                                </tr>
