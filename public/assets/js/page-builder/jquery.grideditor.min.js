        ...
        return c.each(function(c, d) {
            ...
            function k(b, c) {
                ...
                return c.forEach(function(c) {
                    var d = a('<a class="btn btn-sm btn-default" />').html(c.label).attr("title", c.title ? c.title : 'Toggle "' + c.label + '" styling').toggleClass("active btn-success", b.hasClass(c.cssClass)).on("click", function() {
                        d.toggleClass("active btn-success"), b.toggleClass(c.cssClass, d.hasClass("active"))
                    }).appendTo(e)
                }), d
            }
