...
function drawBasic() {
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 400,
       colors: ["#2a8c28", "#1ea6ec", "#22af47", "#007bff", "#FF5370"]
      };
  ...
  if ($("#pie-chart3").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 400,
        colors: ["#2a8c28", "#1ea6ec", "#22af47", "#007bff", "#FF5370", "#FF5370"]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#2a8c28", "#1ea6ec", "#22af47", "#007bff", "#ff9f40", "#FF5370","#2a8c28", "#1ea6ec", "#22af47", "#007bff", "#ff9f40", "#FF5370","#2a8c28", "#1ea6ec", "#22af47", "#007bff", "#ff9f40", "#FF5370", "#fd7b6c", "#22af47","#007bff", "#ff9f40"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: ["#2a8c28", "#1ea6ec", "#22af47", "#FF5370", "#007bff"]
    };
  ...
  if ($("#area-chart2").length > 0) {
    ...
    var options = {
      ...
      width:'100%',
      height: 400,
      colors: ["#2a8c28", "#1ea6ec", "#22af47", "#007bff"]
    };
