...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: ["#1ea6ec", "#2a8c28" ,"#ff5370"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: ["#ff9f40", "#1ea6ec" ,"#2a8c28" ,"#ff5a75" ,"#ff9f40", "#1ea6ec" ,"#2a8c28"],
                stacked: !0
            });
        });
    }
