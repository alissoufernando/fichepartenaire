...
$(function() {
    ...
    var choiceContainer = $("#choices");
        $.each(datasets, function(key, val) {
            choiceContainer.append("<div class='checkbox checkbox-success m-squar'><input type='checkbox' name='" + key +
        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: ["#007bff", "#1ea6ec" ,"#2a8c28" ,"#ff5a75" ,"#007bff", "#1ea6ec" ,"#2a8c28"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            ...
            {color: "#2a8c28", lines: {show: true}, points: data3_points, data: data3, label: "data3"},
