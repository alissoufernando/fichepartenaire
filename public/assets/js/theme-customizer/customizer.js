...
$(document).ready(function() {
    ...
    $('.main-layout li').on('click', function() {
        ...
        if(layout == 'rtl') {
            $("#bootstrap-file").attr("href", bs_rtl_js);
        } else {
            $("#bootstrap-file").attr("href", "#");
        }
    });
});
